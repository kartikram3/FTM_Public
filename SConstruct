...
def buildSim(cppFlags, dir, type, pgo=None):
    ...
    env["CPPFLAGS"] += " -MMD -DBIGARRAY_MULTIPLIER=1 -DUSING_XED -DTARGET_IA32E -DHOST_IA32E -fPIC -DTARGET_LINUX " # -DPDFTOPS_ATTACK  -DGPG_ATTACK"
